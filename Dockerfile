...
RUN apt-get update
RUN apt-get install -y php8.0-cli php8.0-dev php8.0-curl php8.0-mysql php8.0-mbstring php8.0-pgsql php8.0-xml php8.0-zip php8.0-redis php8.0-intl php8.0-xdebug
